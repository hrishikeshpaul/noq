  ...
  <div>
      ...
      <div class="container">
        <div style="display: block;">
          <div class="mt-4">
            <b-card style="border-radius: 8px !important; background-color: rgb(252,252,252); max-height: 720px; margin-top: -30px; overflow-y: auto; transition: all 0.5s;">
    ...
    <!-- WHAT DO WE OFFER -->
    <div style="background-color: white; align-items: center; padding-bottom: 20px;" class="pt-3 pb-5">
