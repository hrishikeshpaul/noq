  ...
  methods: {
      ...
      axios
        ...
        .then(response => {
          ...
          this.$swal({
            ...
            imageWidth: 20,
            html:
              "<span style=\"font-family: 'Raleway', sans-serif; font-size: 16px; font-weight: 200;padding-top: 10px;\">Your profile has been set up!</span>",
            title:
              "<h3 style=\"font-family: 'Raleway', sans-serif; font-size: 16px; font-weight: 300\">Successful!</h3>"
          });
          this.$router.push({
            name: "HomePage"
          });
    ...
    deleteItem(index, array) {
      if (array === "education") {
        ...
        this.honors = this.honors.splice(this.honors.indexOf(index), 1);
      }
    },
    logout() {
